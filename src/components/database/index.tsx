...
import { DATABASE_CONFIG, fetchTableData, deleteRow, upsertRow } from '@/components/database/logic';
import { styles } from '@/components/database/style'; // Use your external styles
